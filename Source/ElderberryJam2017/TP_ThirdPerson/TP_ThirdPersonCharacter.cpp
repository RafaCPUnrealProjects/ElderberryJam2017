...
void ATP_ThirdPersonCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	//PlayerInputComponent->BindAction("Fire", IE_Pressed, this, &ATP_ThirdPersonCharacter::OnHitting);
	PlayerInputComponent->BindAction("Fire2", IE_Pressed, this, &ATP_ThirdPersonCharacter::OnFire);
...
void ATP_ThirdPersonCharacter::OnHitting()
{
